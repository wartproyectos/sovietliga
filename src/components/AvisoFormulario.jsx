...
export function AvisoFormulario({ mostrarSiempre = false }) {
  ...
  return (
    <section className="sv-panel overflow-hidden mx-4 mb-6 flex flex-col md:flex-row items-stretch">
      <div className="flex-1 p-5 sm:p-6 flex flex-col gap-2">
        <p className="text-xs font-bold uppercase tracking-[0.14em] text-[var(--sv-primary-strong)]">
          ¡Camarada Soviet!
        </p>
        <p className="text-sm sm:text-base text-[var(--sv-on-surface)] leading-snug">
          Recuerda apuntarte cada jornada a través del formulario. Tienes hasta las{' '}
          <b>12:00 del domingo</b> antes del partido para dejar tu respuesta.
        </p>
      </div>
      <a
        href={FORMULARIO_URL}
        ...
        className="sv-btn-primary flex items-center justify-center gap-2 px-6 py-4 md:py-0 md:min-w-[10rem] font-bold uppercase tracking-[0.08em] text-sm shrink-0"
      >
        Abrir Formulario
        <svg
          viewBox="0 0 20 20"
